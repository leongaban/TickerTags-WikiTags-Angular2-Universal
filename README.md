![WikiTags](https://github.com/TickertTags/wikitags/blob/master/src/assets/wikitags-logo.png?raw=true)

https://wikitags.com/wiki

# WikiTags built using the Angular 2 Universal Starter kit
